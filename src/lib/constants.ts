...
export const PRICING = {
  ...
  groupBuy: {
    ...
    highlight: "拼的多，省的多——同样的师资，分摊的人越多，每个人越划算",
  },
  faq: [
    { q: "价格含教材吗？", a: "价格包含常规教材和资料。特殊教材（如原版进口教材）需另行购买。" },
    { q: "课包买大更便宜吗？", a: "不，我们不推长课包。无论买多少课时，单价都是一样的。我们的目标不是锁住你，而是帮你尽快达到目标。" },
    { q: "如果中途想要换成其他班型？", a: "可以灵活调整。换之后按照新班型的课时费收取，之前的课时不受影响。" },
    { q: "中途从标准小班转到拼团小班怎么算？", a: "可以转。转后按拼团小班价格执行，转之前的课时不退还差价。" },
    { q: "有试听课吗？", a: "有。我们提供1小时付费试听/诊断评估，按正常课时收费。如果后续报课，试听当小时的费用可抵扣——相当于免费试听一课时。" },
  ],
  cta: "预约试听，体验真经教学",
